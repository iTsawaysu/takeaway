...
import static com.sun.takeaway.constant.RedisConstant.TTL_FIVE;
import static com.sun.takeaway.constant.RedisConstant.CACHE_USER_CAPTCHA;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public CommonResult<String> sendMessage(User user, HttpSession session) {
        ...
        stringRedisTemplate.opsForValue().set(CACHE_USER_CAPTCHA + phone, captcha, TTL_FIVE, TimeUnit.MINUTES);
    ...
    public CommonResult<String> login(Map<String, String> map, HttpSession session) {
        ...
        String captcha = stringRedisTemplate.opsForValue().get(CACHE_USER_CAPTCHA + phone);
        ...
        if (StringUtils.equals(code, captcha)) {
            ...
            stringRedisTemplate.delete(CACHE_USER_CAPTCHA + phone);
